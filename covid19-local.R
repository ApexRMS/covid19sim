...
dataFolder = "C:/gitprojects/Covid19Canada"

# Git repository for World data: see https://github.com/CSSEGISandData/COVID-19
dataWorldFolder = "C:/gitprojects/COVID-19/csse_covid_19_data/csse_covid_19_time_series"

# Folder for input data files
inputFolder = "C:/gitprojects/covid19sim/data"

# Folder for output data files
outputFolder = "C:/gitprojects/covid19sim/data"

# Folder for output plot PNG files
plotFolder = "C:/covid19/plots"

# Folder for SyncroSim template libraries
templateFolder = "C:/covid19/templates"
