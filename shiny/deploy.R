...
# This script copies the most up-to-date model outputs from the "data" folder to the "shiny/covid19canada" folder
...
# Copy files to "shiny/covid19canada" folder
file.copy(paste0("data/", outputFiles), "shiny/covid19canada")
